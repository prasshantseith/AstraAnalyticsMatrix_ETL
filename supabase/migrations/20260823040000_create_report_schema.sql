...
CREATE TABLE IF NOT EXISTS "Report"."dimDate"
(
...
ALTER TABLE IF EXISTS "Report"."dimDate"
    OWNER to postgres;
-- Index: idx_dimdate_date

-- DROP INDEX IF EXISTS "Report".idx_dimdate_date;

CREATE INDEX IF NOT EXISTS idx_dimdate_date
    ON "Report"."dimDate" USING btree
    ("Date" ASC NULLS LAST)
    TABLESPACE pg_default;
-- Index: idx_dimdate_iscurrent

-- DROP INDEX IF EXISTS "Report".idx_dimdate_iscurrent;

CREATE INDEX IF NOT EXISTS idx_dimdate_iscurrent
    ON "Report"."dimDate" USING btree
    ("IsCurrentDate" ASC NULLS LAST, "IsCurrentWeek" ASC NULLS LAST, "IsCurrentMonth" ASC NULLS LAST, "IsCurrentYear" ASC NULLS LAST)
    TABLESPACE pg_default;
-- Index: idx_dimdate_monthyear

-- DROP INDEX IF EXISTS "Report".idx_dimdate_monthyear;

CREATE INDEX IF NOT EXISTS idx_dimdate_monthyear
    ON "Report"."dimDate" USING btree
    ("MonthYearKey" ASC NULLS LAST)
    TABLESPACE pg_default;
-- Index: idx_dimdate_year_month

-- DROP INDEX IF EXISTS "Report".idx_dimdate_year_month;
